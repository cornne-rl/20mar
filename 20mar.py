...
students = str(input("ใส่รายชื่อนักเรียนที่เข้าร่วม (คั่นด้วยเครื่องหมาย ,)")).split(",")
students = [s.strip() for s in students if s.strip()]  # ลบช่องว่างและจัดรูปแบบชื่อให้เรียบร้อย
